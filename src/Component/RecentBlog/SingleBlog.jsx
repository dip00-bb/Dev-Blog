...
//     return (
//         <div>
//             <div className="hover:bg-gray-100 duration-300 md:hover:scale-120 md:hover:z-30 flex max-w-[90rem] mx-auto p-4 items-center justify-between space-x-4 bg-white rounded-lg shadow-sm">
        ...
        <div data-aos="zoom-in" className="p-4">
            <div className="bg-white rounded-xl shadow-md border border-gray-200 hover:shadow-lg transition duration-300 max-w-md mx-auto flex flex-col h-full">
                ...
                <div className="p-4 flex flex-col flex-grow">
                    ...
                    <p className="text-sm text-gray-600 mt-2 line-clamp-3">{short_description}</p>
                </div>
