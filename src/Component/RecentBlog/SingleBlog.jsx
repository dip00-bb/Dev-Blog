            ...
            <div className="flex max-w-[90rem] mx-auto p-4 items-center justify-between space-x-4 bg-white rounded-lg shadow-sm">
                ...
                <div className="flex-1">
                    ...
                    <div className='flex flex-wrap gap-3'>
                        <Link to={`blogdetails/${_id}`} class="relative inline-flex items-center justify-start py-3 pl-4 pr-12 overflow-hidden font-semibold text-indigo-600 transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 bg-blue-200 group">
